...
unittest {
    ...
    s3.upload2("bucket", "myfile", cast(ubyte[])[48,49,50,51,52,53]);


    import std.algorithm : joiner;
    import std.array : array;
    s3.download2("bucket", "myfile").receiveAsRange.joiner().array().writeln();
    ...
    while(true)
        {
            auto result = s3.list2("bucket", "/", null,marker,100);
